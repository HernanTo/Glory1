    ...
    <div class="contenedor">
        ...
        foreach($seller as $datosseller){
            $html .= '<tr>
                ...
                <td style="width: 25px;">:</td>
                <td><i>'. $datosseller['fi_lastname'] . ' ' . $datosseller['sc_lastname'] .' ' . $datosseller['ft_name'] .'</i></td>
                ';
        }
                                $html .= '</tr>
                            </table>
                    ...
                    <div class="con-table-produ">
                        <table class="tabla-ord">
                            <tr class="header-tab">
                                <th style="width: 100px; border-radius: 12px 0px 0px 12px;">Material</th>
                                <th style="width: 165px;">Descripción</th>
