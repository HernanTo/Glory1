<?php
        ...
        function mergeCells($numcelda, $activeWorksheet){
                ...
                $style = $activeWorksheet->getStyle('I23');
                $activeWorksheet->duplicateStyle($style, 'I' . $numcelda);
        ...
        $spreadsheet = $reader->load("../../assets/formatos/cotizaciondefault.xlsx");
        ...
        foreach($product as $datosProducto){
                ...
                $activeWorksheet->setCellValue('I'.$numCell, $stock);
