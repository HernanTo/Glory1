    ...
    He =
      ...
      (w.defaults = {
        ...
        oLanguage: {
          ...
          sEmptyTable: "No existen registros, Cree nuevos registros",
...
!(function (t) {
  ...
  return (
    ...
    x.extend(o.ext.classes, {
      ...
      sFilterInput: "form-control form-control-sm searchtable-lotus",
      sLengthSelect: "form-select form-select-sm selecttable-lotus",
      sProcessing: "dataTables_processing card",
      sPageButton: "paginate_button page-item pagination-lotus",
    }),
...
!(function (o) {
    ...
    ? ((a = require("jquery")),
      ...
      "undefined" != typeof window
        ? (module.exports = function (e, d) {
            return (
              (e = e || window), (d = d || a(e)), n(e, d), o(d, e, e.document)
            );
          })
        : (n(window, a), (module.exports = o(a, window, window.document))))
  ...
  var s,
    ...
    u = e.bootstrap;
  return (
    (a.Responsive.bootstrap = function (e) {
      u = e;
    }),
    (n.modal = function (t) {
      return (
        ...
        function (e, d, o) {
          ...
          i.fn.modal
            ? d ||
              (t &&
                t.header &&
                ((n = (a = r.find("div.modal-header")).find("button").detach()),
                a
                  .empty()
                  .append('<h4 class="modal-title">' + t.header(e) + "</h4>")
                  .append(n)),
              r.find("div.modal-body").empty().append(o()),
