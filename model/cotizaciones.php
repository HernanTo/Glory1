<?php
    class Cotizaciones{
        public function store($date_bill, $reference, $product_amount, $product_id, $customer, $seller, $product_price){
            ...
            $input = "INSERT INTO cotizaciones(num_fact, total_prices, subtotal, amount, date, vendedor, cliente, state) VALUES ('$reference','$total','$subT','$amountT','$date_bill','$seller','$customer', 1)";
            ...
            for ($i=0; $i < sizeof($product_id) ; $i++) { 
                ...
                $input = "INSERT INTO cotizaciones_has_product(id_cotizacion , id_product, price_u, amount, prices_total, date, stock) VALUES ('$bill','$product_id[$i]','$product_price[$i]','$product_amount[$i]','$priceTp','$date_bill', '$stock')";
